...
# The site itself is published from public/; the queue and the ledger are
# build-time bookkeeping and stay at the repository root, unserved.
...
def main():
    ...
    targets = {
        "en": os.path.join(SITE, "news", slug + ".html"),
        "ar": os.path.join(SITE, "ar", "news", slug + ".html"),
    }
    templates = {
        "en": os.path.join(SITE, "news", "_template.html"),
        "ar": os.path.join(SITE, "ar", "news", "_template.html"),
    }
    ...
    news_en = read(os.path.join(SITE, "news.html"))
    ...
    for lang, path, marker in (
        ("en", os.path.join(SITE, "news.html"), EN_NEWS_MARKER),
        ("ar", os.path.join(SITE, "ar", "news.html"), AR_NEWS_MARKER),
    ):
    ...
    for lang, path in (
        ...
        ("ar", os.path.join(SITE, "ar", "index.html")),
    ):
        block = "".join(
