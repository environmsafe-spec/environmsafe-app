 ...
 * refresh token. Credentials live in Netlify environment variables and never
 * reach the browser.
 */
...
function requireEnv(name) {
  ...
  if (!value) throw new Error(`Missing environment variable ${name}. See AGENT_SETUP.md.`);
  return value;
}
